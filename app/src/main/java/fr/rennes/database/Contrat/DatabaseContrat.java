...
public class DatabaseContrat {
    ...
    public static final String GETINSTANCE = "Get instance of ";
    public static final String OPENDB = "Open database";
    public static final String CLOSEDB = "Close database";
}
